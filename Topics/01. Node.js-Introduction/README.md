...
## What is Node.js? How to use Node.js? How to run it with TypeScript?
...
- Node.js runs JavaScript
  - So, generally the TypeScript must be compiled to standard JS
- Yet, this does not work out-of-the-box
  - All of the Node.js packages are coded in regard of JavaScript, not TypeScript
  - The TypeScript code won't compiler at all
- How to solve this?
  - You must install the necessary mappings
  - For built-in packages: `$ npm install --save-dev @types/node`
  - For third-part packages, search their mappings
    - For mongoose: `$ npm install --save-dev @types/mongoose`
